...
namespace BarberShop.Data
{
    public class VietnameseIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError { Code = nameof(LoginAlreadyAssociated), Description = "Tài khoản này đã được liên kết với một người dùng khác." };
        }

        public override IdentityError InvalidUserName(string userName)
        {
            return new IdentityError { Code = nameof(InvalidUserName), Description = $"Tên đăng nhập '{userName}' không hợp lệ, chỉ được chứa chữ cái và số." };
        }
        ...
        {
            return new IdentityError { Code = nameof(UserLockoutNotEnabled), Description = "Tính năng khóa tài khoản chưa được kích hoạt." };
        }
